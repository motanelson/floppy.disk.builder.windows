...
#define DISK_SIZE_1440K  (1440 * 1024)
...
int main(int argc, char *argv[]) {
    ...
    for (i = 0; i < DISK_SIZE_1440K / SECTOR_SIZE; i++)
    ...
    puts("Imagem FAT12 1.44MB criada com sucesso.");
    return 0;
}
