...
unsigned char heads[] = {
  ...
  0x02, 0x04, 0x04, 0x00, 0x02, 0x00, 0x02, 0x00, 0xa8, 0xf8, 0x2c, 0x00,
  0x20, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x80, 0x00, 0x29, 0xe9, 0xeb, 0x47, 0x25, 0x4e, 0x4f, 0x20, 0x4e, 0x41,
...
int main(int argc,char *argv[]){
    ...
    if(argc>1){
        ...
        n=0;
        f2=fopen(argv[1],"w");
        for(n=0;n<2688;n++)fwrite(cc,4096*2,1,f2);
        fclose(f2);
        f1=fopen(argv[1],"r+");
