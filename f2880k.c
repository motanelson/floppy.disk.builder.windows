//gcc -o f288 f288.c -lc
#include<stdlib.h>
#include<stdio.h>
#include<string.h>
unsigned char heads[] = {
  0xeb, 0x3c, 0x90, 0x6d, 0x6b, 0x66, 0x73, 0x2e, 0x66, 0x61, 0x74, 0x00,
  0x02, 0x02, 0x01, 0x00, 0x02, 0xe0, 0x00, 0x80, 0x16, 0xf0, 0x09, 0x00,
  0x24, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x29, 0xc6, 0x76, 0x50, 0x57, 0x4e, 0x4f, 0x20, 0x4e, 0x41,
...
int main(int argc,char *argv[]){
    ...
    if(argc>1){
        ...
        n=0;
        f2=fopen(argv[1],"w");
        for(n=0;n<360;n++)fwrite(cc,4096*2,1,f2);
        fclose(f2);
        f1=fopen(argv[1],"r+");
