...
#define DISK_SIZE_720K  (720 * 1024)
...
uint16_t BPB_TotSec16   = 1440;
uint8_t  BPB_Media      = 0xF9;
uint16_t BPB_FATSz16    = 3;
...
uint32_t BS_VolID     = 0x6A227374;
char     BS_VolLab[11] = "NO NAME    ";
char     BS_FilSysType[8] = "FAT12   ";

/* FAT initial bytes */
uint8_t FAT_init[3] = { 0xF9, 0xFF, 0xFF };
...
int main(int argc, char *argv[]) {
    ...
    for (i = 0; i < DISK_SIZE_720K / SECTOR_SIZE; i++)
    ...
    puts("Imagem FAT12 720K criada com sucesso.");
    return 0;
}
